...
urlpatterns = [
    ...
    path('reset_confirm/<uidb64>/<token>/',MyPasswordResetConfirmView.as_view(template_name='user/confirmation.html'),name='confirmation'),
    path('submit_password/<uidb64>/<token>/',PasswordSubmit.as_view(), name='password_confirm'),
